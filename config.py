...
CHANNEL = os.environ.get("CHANNEL", "Tamil_Dubbed_Anime_Series") # username without '@'
BOT_USERNAME = os.environ.get("BOT_USERNAME","XRenamerPro_Bot") # username without '@'
SUPPORT_GROUP = os.environ.get("SUPPORT_GROUP","anime_Hub_Team") # username without '@'
UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL","Tamil_Dubbed_Anime_Series") # username without '@'
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","ZxZenitsu")
